...
function masterconnect(){
	...
	global '.'$'.'dbcon;
	'.'$'."dbcon = mysqli_connect('$host', '$user', '$pass', '$name','$dbport') or die ('Database connection failed');
}

function loginconnect(){

	global ".'$'.'dbconL;
	'.'$'."dbconL = mysqli_connect('$host', '$user', '$pass', '$name','$dbport');
}
...
";
        ...
        $dbconnect = mysqli_connect($host, $user, $pass, $name,$dbport) or die('Database connection failed');
