...
$info=array("playerid"=>"用户ID");
$side=array("cop"=>"警察","med"=>"医生","hunter"=>"赏金");
if($_SESSION["Admin"]>1)
{
	if($_SESSION["Admin"]<3) {$side=array("cop"=>"警察");}
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		$sql="insert into bewhitelist.whitelist (playerid,work) values(";
...
?>
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?page=18" class="edit" method="post">
