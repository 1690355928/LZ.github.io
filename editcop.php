...
$pinfo=array("cash"=>"现金","bankacc"=>"银行存款","worldSpace"=>"坐标","aliases"=>"最初姓名");
$ginfo=array("coplevel"=>"警察等级","swatlevel"=>"特警等级");
if($_SESSION["Admin"]>1)
{
